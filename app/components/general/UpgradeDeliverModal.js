...
export default function UpgradeDeliverModal({
  openUpgradeDeliverModal,
  setOpenUpgradeDeliverModal,
  plan,
  heading,
  subheading,
}) {
  ...
  const handleSubscription = (plan) => {
    ...
    if (balance < amount) {
      ...
      setTimeout(() => {
        handleRefresh();
        setOpenUpgradeDeliverModal(false);
      }, 1000);
    }
  };
  ...
  return (
    <Modal
      animationType="slide"
      transparent={true}
      visible={openUpgradeDeliverModal}
    >
      <View
        style={{
          flex: 1,
        ...
        >
          ...
          >
            ...
            <TouchableOpacity
              ...
              onPress={() => setOpenUpgradeDeliverModal(false)}
            >
